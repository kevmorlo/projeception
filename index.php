    ...
    <h1 class="index-h1">Avec MyProjeception, publiez et rejoignez des projets avec tous les apprenants de l'EPSI !</h1>
        <div class="index-container">
            ...
            <p class="index-paragraph" id="index-p2">
                Cet outil vous est proposé par le MyDIL, et à été conçu et réalisé par des apprenants en socle numérique.
            </p>
            <p class="index-paragraph" id="index-p3">
                Alors, prêt à redoubler d'innovation et à vous investir dans un projet?
            </p>
        </div>
</body>
</html>